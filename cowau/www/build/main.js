...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__popover_popover__ = __webpack_require__(201);
...
var FlipitPage = /** @class */ (function () {
    function FlipitPage(navCtrl, navParams, gesturesService, platform, popoverCtrl) {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_device_motion__ = __webpack_require__(302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_http__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_flipit_flipit__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__popover_popover__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_visual_visual__ = __webpack_require__(306);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_server_server__ = __webpack_require__(307);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__popover_popover__["a" /* PopoverPage */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_flipit_flipit__ = __webpack_require__(200);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmojiPage = /** @class */ (function () {
    ...
    EmojiPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-emoji',template:/*ion-inline-start:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\emoji\emoji.html"*/'<div class="headline">\n\n  Who are you?\n\n</div>\n\n\n\n<div class="subline">\n\n  Pick your Emoji. \n\n</div>\n\n\n\n<canvas id="canvas" class="canvas-emoji"></canvas>\n\n\n\n<div class="bottom-bar"></div>\n\n\n\n<div class="background-pattern-dark"></div>\n\n'/*ion-inline-end:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\emoji\emoji.html"*/,
        }),
...
var EditPage = /** @class */ (function () {
    ...
    EditPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit',template:/*ion-inline-start:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\edit\edit.html"*/'<!-- <div class="headline">\n\n	Edit Screen\n\n</div>\n\n\n\n<div class="subline">\n\n	Make your Sound\n\n</div> -->\n\n\n\n<div class="beatgrid" id="content">\n\n	<div *ngFor="let cell of beatGrid; let i = index" class="beatrow">{{i}}\n\n		<div (click)="clicked($event)" *ngFor="let cell of beatGrid[0]; let j = index" id="{{i}}-{{j}}" class="tone">\n\n			\n\n		</div>\n\n	</div>\n\n</div>\n\n\n\n<div class="bottom-bar"></div>\n\n\n\n<div class="background-pattern-dark"></div>\n\n'/*ion-inline-end:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\edit\edit.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavParams */]])
    ], EditPage);
    return EditPage;
...
var VisualPage = /** @class */ (function () {
    ...
    VisualPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-visual',template:/*ion-inline-start:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\visual\visual.html"*/'<canvas id="canvas" class="canvas-visual"></canvas>\n\n\n\n<div class="background-pattern"></div>\n\n'/*ion-inline-end:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\visual\visual.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__services_gestures_service__["a" /* GesturesService */]])
    ], VisualPage);
    return VisualPage;
...
var ServerPage = /** @class */ (function () {
    ...
    ServerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-server',template:/*ion-inline-start:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\server\server.html"*/'<input [(ngModel)]="testMessage" type="text" placeholder="Message">\n\n\n\n<button (click)="sendMessage()" class="button button-small">\n\nSend\n\n</button>\n\n'/*ion-inline-end:"C:\Users\Patrick\Documents\Develop\nodejsdings\cowau-2018\cowau\src\pages\server\server.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_device_motion__ = __webpack_require__(302);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;

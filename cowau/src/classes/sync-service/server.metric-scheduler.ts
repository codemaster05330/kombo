import { ServerClockSync } from './server.clock-sync';

export class ServerMetricScheduler {
	_clockSync:any;
	_broadcastFunction:any;
	_ref:any;
	_nextRef:any;

	constructor(clockSync:ServerClockSync, broadcastFunction) {

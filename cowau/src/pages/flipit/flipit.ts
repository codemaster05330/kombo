...
import { NavController, NavParams, Platform, PopoverController, ViewController, Events } from 'ionic-angular';
...
export class FlipitPage {
	...
	constructor(public navCtrl: NavController, public navParams: NavParams, private gesturesService:GesturesService, public platform:Platform, 
		public popoverCtrl:PopoverController, public viewCtrl:ViewController, public events:Events) {
